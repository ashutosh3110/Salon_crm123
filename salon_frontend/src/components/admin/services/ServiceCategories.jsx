        ...
        <div className="space-y-6">
                    ...
                    <div key={cat.id} className="bg-surface p-6 rounded-3xl border border-border shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
                        <div className="flex justify-between items-start mb-4 relative z-10">
                            ...
                            <div className="flex gap-1">
                                <button className="p-2 rounded-xl hover:bg-surface-alt text-text-muted hover:text-primary transition-all">
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-xl hover:bg-surface-alt text-text-muted hover:text-text transition-all"
                                >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-surface-alt text-text-secondary text-[10px] font-bold uppercase tracking-widest border border-border/50">
            ...
            {isAddModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="bg-surface rounded-3xl p-6 w-full max-w-sm relative z-10 shadow-2xl animate-in zoom-in-95 duration-200 border border-border">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <input
                                    type="text"
                                    autoFocus
                                    className="w-full px-4 py-2.5 rounded-xl bg-surface-alt border border-border text-sm font-bold focus:ring-2 focus:ring-primary/20 outline-none text-text"
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="flex-1 py-2.5 rounded-xl border border-border text-xs font-bold text-text-secondary hover:bg-surface-alt transition-all"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleAdd}
                                    className="flex-1 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-bold shadow-lg shadow-primary/20 hover:brightness-110 active:scale-95 transition-all"
                                >
                                    Add Category
                                </button>
                            </div>

            ...
            <div className="flex items-center justify-between h-14 px-4 sm:px-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-text-secondary hidden sm:block">POS Terminal</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2 pl-3 border-l border-border/40 ml-1">
                        ...
                        <div className="hidden sm:block">
                            <div className="text-sm font-medium text-text leading-none">Receptionist</div>
                            <div className="text-[11px] text-text-muted mt-0.5">POS Operator</div>
                        </div>
                    </div>
                </div>
            </div>

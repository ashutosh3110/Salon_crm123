...
import {
    ...
    Clock, Settings, LogOut, ChevronLeft, ChevronRight, X, Scissors
} from 'lucide-react';
...
const menuItems = [
    ...
    { label: 'Settings', icon: Settings, path: '/stylist/settings' },
];
            ...
            <div className={`flex items-center h-16 border-b border-border transition-all ${collapsed ? 'justify-center' : 'px-4 justify-between'}`}>
                {!collapsed ? (
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h2 className="text-sm font-bold text-text leading-none">Stylist</h2>

                ...
                >
                    <div style={{ aspectRatio: 'clamp(16, 18, 21)/9', overflow: 'hidden', minHeight: '200px' }}>
                        ...
                        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem' }}>
                            <span style={{ color: 'var(--wapixo-text-muted)', fontSize: '0.65rem', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.4em', marginBottom: '1.5rem' }}>Latest Insight</span>
                                ...
                                {posts.map((post, idx) => (
                                    ...
                                    >
                                        <span style={{ color: 'var(--wapixo-text-muted)', fontSize: '0.65rem', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.3em', display: 'block', marginBottom: '1.25rem' }}>
                                            {post.category} — {new Date(post.createdAt).toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' })}
                                        </span>
                                        ...
                                        <p style={{ color: 'var(--wapixo-text-muted)', fontWeight: 400, fontSize: '0.95rem', lineHeight: 1.7, marginBottom: '2rem' }}>
                                            {post.excerpt}
                                        </p>

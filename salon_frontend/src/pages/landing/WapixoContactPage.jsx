                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 clamp(1rem, 4vw, 2rem) 120px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'clamp(2rem, 5vw, 4rem)' }}>
                    ...
                    >
                        <div style={{ marginBottom: '4rem' }}>
                            <h2 style={{ fontSize: '1.5rem', fontWeight: 400, marginBottom: '2rem', color: 'var(--wapixo-text)' }}>Direct Channels</h2>
                        ...
                        {/* Social / Extra Info */}
                        <div style={{ padding: '2rem', background: 'var(--wapixo-bg-alt)', border: '1px solid var(--wapixo-border)', borderRadius: '4px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                                <Sparkles size={18} color="var(--wapixo-primary)" />
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            position: 'relative',
                            boxShadow: theme === 'dark' ? '0 30px 60px rgba(0,0,0,0.5)' : '0 30px 60px rgba(0,0,0,0.05)'
                        }}
                    >
                        {!submitted ? (
                            <>
                                <h3 style={{ fontSize: '1.8rem', fontWeight: 300, marginBottom: '2.5rem', color: 'var(--wapixo-text)' }}>Submit Inquiry</h3>
                                <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
                                    ...
                                    <motion.button
                                        ...
                                        whileHover={{ backgroundColor: 'var(--wapixo-primary)', color: 'white', scale: 1.02, borderColor: 'var(--wapixo-primary)' }}
                                        whileTap={{ scale: 0.98 }}
                                        style={{
                                            marginTop: '1rem',
                                            padding: '1.1rem',
                            ...
                            >
                                <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'var(--wapixo-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem' }}>
                                    <MessageSquare size={24} color="var(--wapixo-text)" />
                                </div>
                                <h3 style={{ fontSize: '1.5rem', fontWeight: 400, marginBottom: '1rem', color: 'var(--wapixo-text)' }}>Transmission Received</h3>
                                <p style={{ color: 'var(--wapixo-text-muted)', fontSize: '0.95rem', maxWidth: '300px', lineHeight: 1.6, fontWeight: 400 }}>
                                    Your inquiry has been encrypted and sent to our team. Expect a response within one business day.
                                </p>
                                <button
                                    onClick={() => setSubmitted(false)}
                                    style={{ background: 'none', border: 'none', color: 'var(--wapixo-text-muted)', fontSize: '0.8rem', marginTop: '2rem', cursor: 'pointer', textDecoration: 'underline' }}
                                >
...
function ContactMethod({ icon: Icon, label, value, desc }) {
    return (
        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
            <div style={{ width: '45px', height: '45px', background: 'var(--wapixo-bg-alt)', border: '1px solid var(--wapixo-border)', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', shrink: 0 }}>
                <Icon size={18} color="var(--wapixo-primary)" strokeWidth={1.5} />
            </div>
            <div>
                <p style={{ color: 'var(--wapixo-text-muted)', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '0.4rem', fontWeight: 600 }}>{label}</p>
                <p style={{ fontSize: '1.1rem', fontWeight: 400, color: 'var(--wapixo-text)', marginBottom: '0.25rem' }}>{value}</p>
                <p style={{ fontSize: '0.85rem', color: 'var(--wapixo-text-muted)', fontWeight: 400 }}>{desc}</p>
            </div>
        </div>
    );
}
...
function WapixoInput({ label, required, ...props }) {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <label style={{ fontSize: '0.7rem', color: 'var(--wapixo-text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600 }}>
                {label} {required && <span style={{ color: 'var(--wapixo-text-muted)', opacity: 0.5 }}>*</span>}
            </label>
            <input
                {...props}
                style={{

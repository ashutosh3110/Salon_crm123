    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 pb-20">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                ...
                <div className="flex items-center gap-3 px-4 py-2 bg-primary/5 text-primary border border-primary/20 rounded-xl text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Tax & Invoicing */}
                <div className="bg-surface p-8 rounded-xl border border-border shadow-sm space-y-8 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 -mr-12 -mt-12 rounded-xl rotate-45 pointer-events-none" />
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center justify-between p-4 bg-surface-alt/50 border border-border">
                            ...
                            <button
                                ...
                                className={`w-14 h-7 rounded-xl transition-all relative border border-border ${settings.gstEnabled ? 'bg-primary' : 'bg-surface-alt'}`}
                            >
                                <div className={`absolute top-1 w-5 h-5 bg-white rounded-xl transition-all ${settings.gstEnabled ? 'left-8' : 'left-1'} shadow-sm`} />
                            </button>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-4 rounded-xl border border-border bg-surface-alt text-[11px] font-black tracking-widest focus:ring-1 focus:ring-primary/40 outline-none transition-all"
                                    />
                                </div>
                            </div>
                        )}
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 rounded-xl border border-border bg-surface-alt text-[11px] font-black tracking-widest focus:ring-1 focus:ring-primary/40 outline-none transition-all"
                                />
                            </div>
                            <div className="space-y-3">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <input
                                ...
                                className="w-full accent-primary h-2 bg-surface-alt rounded-xl appearance-none cursor-pointer"
                            />
                        ...
                        <div className="flex items-center justify-between p-4 bg-surface-alt/50 border border-border">
                            ...
                            <button
                                ...
                                className={`w-14 h-7 rounded-xl transition-all relative border border-border ${settings.couponsEnabled ? 'bg-primary' : 'bg-surface-alt'}`}
                            >
                                <div className={`absolute top-1 w-5 h-5 bg-white rounded-xl transition-all ${settings.couponsEnabled ? 'left-8' : 'left-1'} shadow-sm`} />
                            </button>
                        </div>
                    </div>
                </div>
                ...
                {/* Payment Methods */}
                <div className="bg-surface p-8 rounded-xl border border-border shadow-sm space-y-8 lg:col-span-2">
                    <h3 className="text-sm font-black text-text uppercase tracking-widest flex items-center gap-3 border-b border-border pb-5">
                    ...
                    <div className="flex flex-wrap gap-4">
                        {modes.map(mode => (
                            <button
                                ...
                                className={`px-8 py-4 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all border ${settings.allowedModes.includes(mode)
                ...
                <div className="bg-surface p-8 rounded-xl border border-border shadow-sm space-y-8 lg:col-span-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            className="w-full h-24 px-5 py-4 rounded-xl border border-border bg-surface-alt text-[11px] font-bold uppercase tracking-widest focus:ring-1 focus:ring-primary/40 outline-none transition-all resize-none shadow-inner"
                        />
                    </div>
                </div>
            </div>

            <div className="bg-red-500/5 border border-red-500/20 dark:bg-red-950/20 dark:border-red-900/50 p-6 rounded-xl flex items-start gap-5">
            ...
            <div className="flex justify-end gap-4 p-8 bg-surface-alt/30 border-t border-border">
                <button className="px-10 py-4 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] text-text-muted hover:bg-surface-alt transition-all">FACTORY RESET</button>
                <button
                    onClick={() => alert('Configuration broadcast successful!')}
                    className="flex items-center gap-4 px-12 py-4 bg-primary text-primary-foreground rounded-xl text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-primary/30 hover:brightness-110 active:scale-95 transition-all transform hover:-translate-y-1"
                >

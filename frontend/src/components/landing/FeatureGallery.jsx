        ...
        <section className="py-24 bg-surface/30 px-4">
            <div className="max-w-7xl mx-auto md:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16 px-4">
                    <h2 className="text-2xl md:text-5xl font-black text-text mb-4 md:mb-6 leading-tight uppercase tracking-tight">
                        {gallery.heading} <span className="text-primary italic font-serif lowercase caret-transparent">{gallery.heading_accent}</span> {gallery.heading_suffix}
                    </h2>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-100 transition-opacity duration-300">
                                <div className="absolute bottom-0 left-0 p-3 md:p-6">
                                    <h3 className="text-[10px] md:text-lg font-black text-white mb-0.5 md:mb-1 uppercase tracking-wider">{item.title}</h3>

                             ...
                             <motion.div
                                ...
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.boxShadow = theme === 'dark'
                                        ? '0 12px 40px rgba(180, 145, 43, 0.2)'
                                        : '0 12px 40px rgba(180, 145, 43, 0.25)';
                                    e.currentTarget.style.borderColor = 'rgba(180, 145, 43, 0.5)';
                                    e.currentTarget.style.transform = 'translateY(-4px)';
                                }}
                                onMouseLeave={(e) => {
                                    e.currentTarget.style.boxShadow = theme === 'dark' ? '0 20px 50px rgba(0,0,0,0.4)' : '0 20px 50px rgba(0,0,0,0.05)';

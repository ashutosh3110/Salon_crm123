    ...
    return (
        <div className="flex flex-col h-full slide-right overflow-y-auto no-scrollbar pb-10 bg-white dark:bg-transparent">
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 tracking-tight">Finance Ledger & Transactions</h2>
            ...
            {/* Stats Cards */}
            <div className="px-8 py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 border-b border-slate-100 dark:border-slate-750 bg-white dark:bg-transparent">
                {/* Income Card */}
                <div className="p-4 rounded-xl border border-emerald-100 dark:border-emerald-900/30 bg-white dark:bg-slate-800 flex items-center gap-4 shadow-sm">
                    <div className="w-12 h-12 rounded-xl bg-emerald-50 dark:bg-emerald-500/15 text-emerald-500 dark:text-emerald-400 flex items-center justify-center shrink-0 border border-emerald-100 dark:border-emerald-900/30">
                        <Download className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-0.5">Total Income</p>
                        <h3 className="text-xl font-black text-emerald-600 dark:text-emerald-400 leading-tight">₹{totalIncome.toLocaleString('en-IN')}</h3>
                        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-400 mt-0.5">{incomeTxns.length} Transactions</p>
                    </div>
                </div>

                {/* Expense Card */}
                <div className="p-4 rounded-xl border border-rose-100 dark:border-rose-900/30 bg-white dark:bg-slate-800 flex items-center gap-4 shadow-sm">
                    <div className="w-12 h-12 rounded-xl bg-rose-50 dark:bg-rose-500/15 text-rose-500 dark:text-rose-400 flex items-center justify-center shrink-0 border border-rose-100 dark:border-rose-900/30">
                        <Upload className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-0.5">Total Expense</p>
                        <h3 className="text-xl font-black text-rose-600 dark:text-rose-400 leading-tight">-₹{Math.abs(totalExpense).toLocaleString('en-IN')}</h3>
                        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-400 mt-0.5">{expenseTxns.length} Transactions</p>
                    </div>
                </div>

                {/* Net Balance Card */}
                <div className="p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 bg-white dark:bg-slate-800 flex items-center gap-4 shadow-sm">
                    <div className="w-12 h-12 rounded-xl bg-blue-50 dark:bg-blue-500/15 text-blue-500 dark:text-blue-400 flex items-center justify-center shrink-0 border border-blue-100 dark:border-blue-900/30">
                        <Wallet className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-0.5">Net Balance</p>
                        <h3 className="text-xl font-black text-blue-600 dark:text-blue-400 leading-tight">₹{netBalance.toLocaleString('en-IN')}</h3>
                        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-400 mt-0.5">This Period</p>
                    </div>
                </div>

                {/* Total Transactions Card */}
                <div className="p-4 rounded-xl border border-purple-100 dark:border-purple-900/30 bg-white dark:bg-slate-800 flex items-center gap-4 shadow-sm">
                    <div className="w-12 h-12 rounded-xl bg-purple-50 dark:bg-purple-500/15 text-purple-500 dark:text-purple-400 flex items-center justify-center shrink-0 border border-purple-100 dark:border-purple-900/30">
                        <Landmark className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-0.5">Total Transactions</p>
                        <h3 className="text-xl font-black text-purple-600 dark:text-purple-400 leading-tight">{transactions.length}</h3>
                        <p className="text-[10px] font-bold text-slate-400 dark:text-slate-400 mt-0.5">All Transactions</p>
                    </div>
                </div>
            </div>

            {/* Filters Bar */}
            <div className="px-8 py-5 border-b border-slate-100 dark:border-slate-750 bg-white dark:bg-transparent flex flex-col sm:flex-row flex-wrap gap-4 items-stretch sm:items-center">
                <div className="relative flex-1 min-w-[200px]">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 dark:text-slate-500" />
                    <input
                        type="text"
                        placeholder="Search by description, reference, or notes..."
                        className="w-full pl-9 pr-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 rounded-lg text-xs font-semibold focus:outline-none focus:border-slate-300 dark:focus:border-slate-600 transition-colors"
                    />
                </div>
                ...
                <div className="flex items-center gap-2">
                    <div className="relative">
                        <input
                            ...
                            className="px-3 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 rounded-lg text-xs font-semibold focus:outline-none focus:border-slate-300 dark:focus:border-slate-600 w-32"
                        />
                    </div>
                ...
                <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-850 rounded-lg text-xs font-bold transition-colors">
                    <Filter className="w-3.5 h-3.5" />
                    Filters
                </button>

                <button onClick={handleClearFilters} className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-850 rounded-lg text-xs font-bold transition-colors">
            ...
            <div className="px-8 mt-6">
                ...
                {loading ? (
                    ...
                    <div className="py-24 text-center bg-white dark:bg-slate-800/60 flex flex-col items-center justify-center rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-sm backdrop-blur-sm">
                        <img src="/vector iamge 4.png" alt="No Transactions" className="w-48 h-48 object-contain mb-6" />
                        <h3 className="text-sm font-black text-slate-800 dark:text-slate-200 uppercase tracking-widest mb-2">No Transactions Found</h3>
                        <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 max-w-sm mb-6">
                    ...
                    <div className="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl overflow-hidden shadow-sm backdrop-blur-sm">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-white dark:bg-slate-800/40 border-b border-slate-200 dark:border-slate-750 text-[10px] font-black text-slate-800 dark:text-slate-200 uppercase tracking-widest">
                                        <th className="pr-6 py-4"><div className="pl-4 flex items-center gap-1 w-full justify-start">Date <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="pl-3 flex items-center gap-1 w-full justify-start">Type <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center gap-1 w-full justify-start">Category <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center gap-1 w-full justify-start">Outlet <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center gap-1 w-full justify-start">Account <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center gap-1 w-full justify-start">Payment Method <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center justify-start gap-1 w-full">Amount <ArrowDownUp className="w-3 h-3 text-slate-400" /></div></th>
                                        <th className="px-6 py-4"><div className="flex items-center justify-center w-full">Actions</div></th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-750 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-transparent">
                                    {transactions.map((t) => {
                                        const isIncome = t.type === 'income' || t.category === 'Owner Investment';
                                        
                                        return (
                                            <tr key={t._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-750/30 transition-colors relative group">
                                                
                                                <td className="pr-6 py-4 font-bold whitespace-nowrap relative">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex justify-start">
                                                        <span className={`px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${isIncome ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400' : 'bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-400'}`}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex flex-col justify-start items-start">
                                                        ...
                                                        <span className="text-[10px] font-medium text-slate-500 dark:text-slate-400">{t.description || 'General entry'}</span>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex justify-start">
                                                ...
                                                <td className="px-6 py-4 uppercase whitespace-nowrap">
                                                    <div className="flex justify-start">
                                                        <span className="px-2 py-1 bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 rounded text-[10px] font-black tracking-widest">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center justify-center gap-2 w-full">
                                                        <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-750 rounded-md transition-colors border border-slate-200 dark:border-slate-700 bg-transparent">
                        ...
                        {/* Pagination Bar */}
                        <div className="px-6 py-4 bg-white dark:bg-transparent border-t border-slate-200 dark:border-slate-750 flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 dark:hover:bg-slate-850 transition-colors"
                                >
                                    <ChevronLeft className="w-4 h-4" />
                                </button>
                                <span className="flex items-center text-xs font-bold px-3 text-slate-600 dark:text-slate-350">

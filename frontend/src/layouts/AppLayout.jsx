...
export default function AppLayout() {
    ...
    useEffect(() => {
        console.log('[FCM Debug] useEffect triggered', { 
            hasCustomer: !!customer, 
            authLoading, 
            alreadyRegistered: hasRegisteredToken.current 
        });

        const handleNotificationToken = async () => {
            if (customer && !authLoading && !hasRegisteredToken.current) {
                console.log('[FCM Debug] Conditions met, starting registration...');
                // Pre-check for support to avoid unnecessary logs
                if (!('Notification' in window)) {
                    console.log('[FCM Debug] Notification API not supported in window');
                    return;
                }
                ...
                if (token) {
                    ...
                    console.warn('No token generated by requestForToken()');
                }
            }
        };
